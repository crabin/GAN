...
def plot_kl_div():
    filePath = './logs/WCGAN_32_1000_256_2_1_5e-06_5e-05_4_tanh_adam_27_2.pickle'
    ...
    fig.savefig('./log_imgs/nsl_kl_div_plot.png', dpi = 350, bbox_inches='tight')
    fig.savefig('./log_imgs/nsl_kl_div_plot.pdf', bbox_inches='tight')
    fig.savefig('./log_imgs/nsl_kl_div_plot.eps',format='eps')
...
def matplotlib_plots(x,y,label_mapping,plot_type='pca'):
    ...
    fig.savefig(f'./log_imgs/{plot_type}.png', dpi = 350, bbox_inches='tight')
    fig.savefig(f'./log_imgs/{plot_type}.pdf', bbox_inches='tight')
